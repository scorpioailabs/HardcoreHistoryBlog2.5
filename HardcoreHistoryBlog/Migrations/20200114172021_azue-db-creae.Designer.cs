...
namespace HardcoreHistoryBlog.Migrations
{
    ...
    [Migration("20200114172021_azue-db-creae")]
    partial class azuedbcreae
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HardcoreHistoryBlog.ViewModels.UserRolesViewModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HardcoreHistoryBlog.Data.ApplicationRole", b =>
                {
                    b.HasOne("HardcoreHistoryBlog.Data.ApplicationUser", null)
                        .WithMany("Roles")
            ...
            modelBuilder.Entity("HardcoreHistoryBlog.Models.Comments.SubComment", b =>
                {
                    b.HasOne("HardcoreHistoryBlog.Models.Comments.MainComment", null)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("HardcoreHistoryBlog.Data.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
